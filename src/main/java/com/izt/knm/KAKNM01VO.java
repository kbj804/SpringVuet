...
public class KAKNM01VO {
	...
	public String toString() {
		return "KNM01VO [question_id=" + question_id
				+ ", up_question_id=" + up_question_id
				+ ", requestion_id=" + requestion_id
				...
				+ ", userid=" + userid
				+ ", tag=" + tag
				+ ", reg_userName_tq=" + reg_userName_tq
				+ ", reg_userid_tq=" + reg_userid_tq
				+ ", reg_date_tq=" + reg_date_tq
				+ ", reg_userName_ta=" + reg_userName_ta
				+ ", reg_userid_ta=" + reg_userid_ta
				+ ", reg_date_ta=" + reg_date_ta
				+ ", tag_tag=" + tag_tag
				+ ", tag_erc=" + tag_erc
				+ ", tag_ert=" + tag_ert
				+ ", sortType=" + sortType
				...
				+ ", customer=" + customer
				+ ", reg_date_st=" + reg_date_st
				+ ", reg_date_ed=" + reg_date_ed
				+ ", post_type=" + post_type
				+ ", post_id=" + post_id
				+ ", tag_type=" + tag_type
				+ ", tag_value=" + tag_value
