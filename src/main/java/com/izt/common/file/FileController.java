...
import static com.izt.common.file.FileCommon.SAVE_PATH;
...
public class FileController {
    ...
    public void download(HttpServletResponse response,
        ...
        try {
            File file = new File(SAVE_PATH + "\\" + fileName); // 경로에서 파일을 가져온다.
            System.out.println("### 경로에서 파일 가져오는데 그 경로가 제대로 인식되는지 모르겠다. ### " + fileName);
