...
public class FileCommon {
    // 파일이 저장될 위치 (로컬. #개발시)
    private static final String SAVE_ROOT = "D:\\Project\\bootRepository-master";
    public static final String SAVE_PATH = SAVE_ROOT + "\\src\\main\\java\\com\\izt\\common\\file\\fileStore";

    // 파일 저장 위치 (#배포시)
//    public static final String SAVE_PATH = "/home/aizt/file/fileStore";
